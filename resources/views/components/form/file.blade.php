...
<div class="{{ !$props['prefix'] ? 'mb-3' : '' }}">
    ...
    <div class="list-group">
        ...
        @include('components.form.file-item', ['file' => $fileItem])
        @endforeach
        @else
        @include('components.form.file-item')
        @endif
        @endif
        <label for="{{ $name }}" role="button" class="list-group-item list-group-item-action
