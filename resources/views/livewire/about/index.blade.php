                    ...
                    <tr>
                        ...
                        <td>
                            <div class="flex justify-end">
                                @can('about_show')
                                <a class="mr-2 btn btn-sm btn-info" href="{{ route('admin.abouts.show', $about) }}">
                                    {{ trans('global.view') }}
                                </a>
                                @endcan
                                @can('about_edit')
                                <a class="mr-2 btn btn-sm btn-success" href="{{ route('admin.abouts.edit', $about) }}">
                                    {{ trans('global.edit') }}
                                </a>
                                @endcan
                                @can('about_delete')
                                <button class="mr-2 btn btn-sm btn-rose" type="button"
                                    wire:click="confirm('delete', {{ $about->id }})" wire:loading.attr="disabled">
                                    {{ trans('global.delete') }}
                                </button>
                                @endcan
                            </div>
