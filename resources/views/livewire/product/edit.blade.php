<form wire:submit.prevent="submit" class="pt-3">
    ...
    <div class="form-group {{ $errors->has('mediaCollections.product_image') ? 'invalid' : '' }}">
        ...
        <x-dropzone id="image" name="image" action="{{ route('admin.products.storeMedia') }}"
            collection-name="product_image" max-file-size="2" max-width="4096" max-height="4096" />
        <div class="validation-message">
