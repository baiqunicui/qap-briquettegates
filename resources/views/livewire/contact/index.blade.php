            ...
            <table class="table w-full table-index">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            {{ $contact->heading[0]['en'] ?? '' }}
                        </td>
                        <td>
                            <div class="flex justify-end">
                                @can('contact_show')
                                <a class="mr-2 btn btn-sm btn-info" href="{{ route('admin.contacts.show', $contact) }}">
                                    {{ trans('global.view') }}
                                </a>
                                @endcan
                                @can('contact_edit')
                                ...
                                <button class="mr-2 btn btn-sm btn-rose" type="button"
                                    wire:click="confirm('delete', {{ $contact->id }})" wire:loading.attr="disabled">
                                    {{ trans('global.delete') }}
                                </button>
                                @endcan
                            </div>
