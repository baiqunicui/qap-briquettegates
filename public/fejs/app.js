...
/***/ "./resources/fejs/alpine-clipboard.umd.js":
/*!************************************************!*\
  !*** ./resources/fejs/alpine-clipboard.umd.js ***!
  \************************************************/
    ...
    start: function start() {
      ...
      Alpine.addMagicProperty("clipboard", function () {
        return function (e) {
          ...
          if (t.value = n, t.setAttribute("readonly", ""), t.style.cssText = "position:fixed;pointer-events:none;z-index:-9999;opacity:0;", document.body.appendChild(t), navigator.userAgent && navigator.userAgent.match(/ipad|ipod|iphone/i)) {
            t.contentEditable = !0, t.readOnly = !0;

            var _e = document.createRange();

            _e.selectNodeContents(t);

            var _n = window.getSelection();

            _n.removeAllRanges(), _n.addRange(_e), t.setSelectionRange(0, 999999);
          } else t.select();
      ...
      n = window.deferLoadingAlpine || function (e) {
    return e();
  };
...
/*!*******************************!*\
  ...
  \*******************************/
__webpack_require__(/*! ./alpine.min.js */ "./resources/fejs/alpine.min.js");

__webpack_require__(/*! ./alpine-clipboard.umd */ "./resources/fejs/alpine-clipboard.umd.js"); // require('./splide.js');
